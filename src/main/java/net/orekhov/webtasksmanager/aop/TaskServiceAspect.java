...
public class TaskServiceAspect {
     ...
     * <p>
     * Этот метод логирует информацию о начале выполнения метода.
     *
     ...
     * <p>
     * Этот метод логирует информацию о завершении выполнения метода.
     *
     * @param joinPoint объект {@link JoinPoint}, содержащий информацию о вызванном методе
     */
    @After("execution(* net.orekhov.webtasksmanager.services.TaskService.*(..))")
     ...
     * <p>
     * Этот метод логирует информацию о том, что метод завершился успешно.
     *
     * @param joinPoint объект {@link JoinPoint}, содержащий информацию о вызванном методе
     */
    @AfterReturning("execution(* net.orekhov.webtasksmanager.services.TaskService.*(..))")
     ...
     * <p>
     * Этот метод логирует информацию о выброшенном исключении.
     *
     * @param joinPoint объект {@link JoinPoint}, содержащий информацию о вызванном методе
     */
    @AfterThrowing("execution(* net.orekhov.webtasksmanager.services.TaskService.*(..))")
     ...
     */
    @Around("execution(* net.orekhov.webtasksmanager.services.TaskService.*(..))")
